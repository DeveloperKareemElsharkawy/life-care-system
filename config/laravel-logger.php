...
return [
    ...
    */
    ...
    'rolesMiddlware' => env('LARAVEL_LOGGER_ROLES_MIDDLWARE', ''),
    ...
    */
    ...
    'defaultUserModel'     => env('LARAVEL_LOGGER_USER_MODEL', 'App\Models\Admin'),
    ...
    */
    ...
    'loggerBladeExtended'       => env('LARAVEL_LOGGER_LAYOUT', 'admin-panel.layouts.master'),
