...
final class CashUserTable extends PowerGridComponent
{
    use ActionButton;
   ...
   */
    ...
    */
    public function datasource(): ?Builder
    {
        ...
        return User::query()->where('contract_type','cash')
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::add()
                ->title(trans('admin/datatable.receipt_number'))
...
//                ->route('admin.users.show', ['user_id' => 'id']),
            ...
            Button::add('edit')
                ...
                ->target('_self')
                ->route('admin.cash-users.edit', ['user_id' => 'id']),
