...
final class VehicleTable extends PowerGridComponent
{
    ...
    //Messages informing success/error data is updated.
    public array $vehiclesIdsForDeletion = [];

    public string $primaryKey = 'vehicles.id';
    ...
    protected function getListeners(): array
    {
        return array_merge(
            parent::getListeners(), [
            'alertEvent',
            'ConfirmRemoveVehicles',
            'deleteConfirmed' => 'deleteVehicles'

        ]);
    }

    public function ConfirmRemoveVehicles($data)
    {
        if (count($this->checkboxValues) == 0 && !isset($data['vehicles_id'])) {
            $this->dispatchBrowserEvent('NoSelectedItemsAlert', ['message' => 'You must select at least one item!']);
            return;
        }

        $systemUsersIds = isset($data['vehicles_id']) ? [$data['vehicles_id']] : $this->checkboxValues;

        $this->vehiclesIdsForDeletion = $systemUsersIds;
    ...
    */
    ...
    {
        return Vehicle::query()->with('owners_percentage.owner', 'owners', 'type');
    }
    ...
    */
    public function addColumns(): ?PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('created_at_formatted', function (Vehicle $model) {
    ...
    public function actions(): array
    {
        return [
            Button::add('edit')
                ...
                ->target('_self')
                ->route('admin.vehicles.edit', ['vehicles_id' => 'id']),
            ...
            Button::add('destroy')
                ...
                ->target('_self')
                ->emit('ConfirmRemoveVehicles', ['vehicles_id' => 'id']),
        ];
    }
    ...
    public function header(): array
    {
        ...
        return [
            ...
            Button::add('bulk-sold-out')
                ...
                ->target('_self')
                ->emit('ConfirmRemoveVehiclesTypes', []),
        ];
    }
    ...
    */
    ...
    /**
     * PowerGrid VehiclesOwner Update.
     *
