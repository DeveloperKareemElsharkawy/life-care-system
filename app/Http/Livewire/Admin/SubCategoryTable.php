...
final class SubCategoryTable extends PowerGridComponent
{
    ...
    */
    ...
    {
        return Category::query()->where('parent_id', $this->categoryId);
    }
...
//            })
            ...
            ->addColumn('parent_categories', function (Category $model) {
                return "<span class='tag badge-gradient-secondary'>" . $model->parentCategory->name . " </span> ";
            })
            ->addColumn('status')
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::add()
                ->title(trans('admin/datatable.code'))
                ->field('code')
                ->sortable()
                ->searchable()
                ->makeInputText(),
            ...
            Column::add()
                ->title(trans('admin/datatable.cash_price'))
                ->field('price')
                ->sortable()
                ->searchable()
                ->makeInputText(),
...
//                ->bodyAttribute('datatable-body-txt', ''),
            ...
            Column::make(trans('admin/datatable.sub_category'), 'parent_categories', 'parent_id')
                ->makeInputSelect(Category::query()->whereNull('parent_id')->get(), 'name', 'parent_id'),
    ...
    public function actions(): array
    {
        return [
            Button::add('edit')
                ...
                ->target('_self')
                ->route('admin.sub-categories.edit', ['sub_category_id' => 'id', 'category_id' => $this->categoryId]),
    ...
    public function header(): array
    {
        ...
        return [
            Button::add('bulk-sold-out')
                ->caption($CreatNewBtnIcon . __('admin/datatable.buttons.c_sub_category'))
                ->class('btn btn-success  btn-svgs btn-svg-white datatable-delete-btn')
                ->target('_self')
                ->route('admin.sub-categories.create', ['category_id' => $this->categoryId]),
