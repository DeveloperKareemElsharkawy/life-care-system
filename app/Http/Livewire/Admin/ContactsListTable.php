...
final class ContactsListTable extends PowerGridComponent
{
    use ActionButton;
    ...
    */
     ...
     *
     * @return  \Illuminate\Database\Eloquent\Builder<\App\Models\Contact>|null
     */
    public function datasource(): ?Builder
    {
        return Contact::query()->where('user_id', $this->userId);
    }
    ...
    */
    ...
    public function columns(): array
    {
        return [
            Column::add()
                ->title(trans('admin/datatable.first_name'))
                ->field('first_name')
                ->searchable()
                ->makeInputText('name')
                ->sortable(),
            ...
            Column::add()
                ->title(trans('admin/datatable.last_name'))
                ->field('last_name')
                ->searchable()
                ->makeInputText('email')
                ->sortable(),
    ...
    public function actions(): array
    {
        return [
            Button::add('edit')
                ...
                ->target('_self')
                ->route('admin.contacts-list.edit', ['user_id' => $this->userId,'contact_list_id' => 'id']),
    ...
    public function header(): array
    {
        ...
        return [
            Button::add('bulk-sold-out')
                ->caption($CreatNewBtnIcon . __('admin/datatable.buttons.c_contact_list'))
                ->class('btn btn-success  btn-svgs btn-svg-white datatable-delete-btn')
                ->target('_self')
                ->route('admin.contacts-list.create', ['user_id' => $this->userId]),
