...
use App\Http\Requests\Admin\Interest\InterestFormRequest;
...
class InterestsController extends Controller
{
     ...
     * @var string
     */
    protected $viewPath = 'admin-panel.interests';
     ...
     * @var string
     */
    protected $routePrefix = 'admin.interests';
     ...
     * @var array|string
     */
    protected $validation = InterestFormRequest::class;
