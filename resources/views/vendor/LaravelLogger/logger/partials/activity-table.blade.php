                ...
                <td>
                    @php
                        switch (strtolower($activity->methodType)) {
                            case 'get':
                                $methodClass = 'tag tag-info';
                                break;

                            case 'post':
                                $methodClass = 'tag tag-warning';
                                break;
