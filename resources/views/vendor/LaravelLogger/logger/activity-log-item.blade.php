                            ...
                            @push(config('LaravelLogger.bladePlacementJs'))
                                ...
                                @php
                                    switch (config('LaravelLogger.bootstapVersion')) {
                                        case '4':
                                            $containerClass = 'card';
                                            $containerHeaderClass = 'card-header mt-5';
                                    ...
                                    switch (strtolower($activity->methodType)) {
                                        case 'get':
                                            $methodClass = 'badge badge-tag tag-info  ';
                                            break;

                                        case 'post':
                                            $methodClass = 'badge badge-tag tag-primary  ';
                                            break;

                                        case 'put':
                                            $methodClass = 'badge badge-tag tag-gray-dark  ';
                                            break;

                                        case 'delete':
                                            $methodClass = 'badge badge-tag tag-danger danger';
                                            break;

                                        default:
                                            $methodClass = 'badge badge-tag tag-info info';
                                            break;
                                    }
                                ...
                                @section('content')
                                    <div class="container-fluid">
                                        ...
                                        <div class="panel @if($isClearedEntry) panel-danger @else panel-default @endif">
                                            <div
                                                class="{{ $containerClass }} @if($isClearedEntry) panel-danger @else panel-default @endif">
                                                <div
                                                    class="{{ $containerHeaderClass }} @if($isClearedEntry) bg-danger text-white @else @endif">
                                                    {!! trans('LaravelLogger::laravel-logger.drilldown.title', ['id' => $activity->id]) !!}
                                                    <a href="@if($isClearedEntry) {{route('cleared')}} @else {{route('admin.activity')}} @endif"
                                                                    ...
                                                                    <ul class="list-group">
                                                                        ...
                                                                        <li class="list-group-item">
                                                                            <dl class="dl-horizontal">
                                                                                ...
                                                                                <dd>@if($activity->details)
                                                                                        {{$activity->details}}
                                                                                    @else
                                                                                        {!! trans('LaravelLogger::laravel-logger.drilldown.list-group.fields.none') !!}
                                                                                    @endif</dd>
                                                                                ...
                                                                                <dd>
                                                                                    <i class="fa {{ $platformIcon }} fa-fw"
                                                                                       aria-hidden="true">
                                                <span class="sr-only">
                                                    {{ $platform }}
                                                </span>
                                                                                    </i>
                                                                                    <i class="fa {{ $browserIcon }} fa-fw"
                                                                                       aria-hidden="true">
                                                <span class="sr-only">
                                                    {{ $browser }}
                                                </span>
                                                                            ...
                                                                            <dl class="dl-horizontal">
                                                                                ...
                                                                                @else
                                                                                    <p class="text-center disabled">
                                                                                        <br/>
                                                                                        Additional Ip Address Data Not
                                                                                        Available.
                                                                                    </p>
                                                                                @endif
                                                                            </dl>
                                                        ...
                                                        <span class="badge badge-{{$labelClass}}">
                                                            {{ $user_role->name }} - {!! trans('LaravelLogger::laravel-logger.drilldown.labels.userLevel') !!} {{ $user_role->level }}
                                                                                    ...
                                                                                    @if($userDetails->last_name || $userDetails->first_name)
                                                                                        ...
                                                                                        <dd>{{$userDetails->last_name}}
                                                                                            , {{$userDetails->first_name}}</dd>
                                                                                    @endif
