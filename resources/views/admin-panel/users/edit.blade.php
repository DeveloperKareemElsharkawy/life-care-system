    ...
    <div class="side-app">
        ...
        <ol class="breadcrumb1">
            ...
            <li class="breadcrumb-item1"><a href="{{route('admin.contract-users.index')}}" class="">
                    {{trans('admin/dashboard.menus.contract_users')}}</a>
            </li>
        ...
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.contract-users.update',['user_id'=>$user->id])}}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <x-admin.text-input :value="$user->referral_desc" name="referral_desc"></x-admin.text-input>
                                </div>
                                ...
                                <div class="col-sm-4 col-md-4 mt-5">
                                    <x-admin.drop-down-input :selected="$user->insurance_company_id" label="insurance_company_id" name="insurance_company_id"
                                ...
                                <div class="col-sm-2 col-md-2 mt-5">
                                    <x-admin.number-input :value="$user->examination_price" name="examination_price"
                                    ></x-admin.number-input>
                                </div>
                                ...
                                <div class="col-sm-2 col-md-2 mt-5">
                                    <x-admin.drop-down-input  :selected="$user->payment_type" label="payment_type" name="payment_type" :options="[
                                ...
                                <div class="col-sm-6 col-md-6 mt-5">
                                    <x-admin.date-picker-input name="examination_date"  :value="$user->examination_date"/>
                                </div>

                                <div class="col-sm-6 col-md-6 mt-5">
                                    <x-admin.drop-down-input :selected="$user->doctor_id" name="doctor_id" label="doctor_id"
...
{{--                                </div>--}}
                                ...
                                <div class="col-sm-6 col-md-6 mt-5">
                                    <x-admin.text-area-input name="consultant_name" :value="$user->consultant_name"></x-admin.text-area-input>
                                </div>

                                <div class="col-sm-6 col-md-6 mt-5">
                                    <x-admin.text-area-input :value="$user->examination_notes" name="examination_notes"></x-admin.text-area-input>
                                </div>
