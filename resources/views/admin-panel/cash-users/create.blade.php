    ...
    <div class="side-app">
        ...
        <ol class="breadcrumb1">
            ...
            <li class="breadcrumb-item1"><a href="{{route('admin.cash-users.index')}}" class="">
                    @lang('admin/dashboard.menus.cash_users')</a>
            </li>
        ...
        <form method="post" autocomplete="off" id="myform" action="{{route('admin.cash-users.store')}}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <x-admin.text-area-input name="referral_desc"></x-admin.text-area-input>
                                </div>
                                ...
                                <div class="col-sm-3 col-md-3 mt-5">
                                    <x-admin.number-input name="receipt_number"
                                    ></x-admin.number-input>
                                </div>
