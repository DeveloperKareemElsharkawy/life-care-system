...
@section('content')
    <div class="side-app">
        <ol class="breadcrumb1">
            ...
            <li class="breadcrumb-item1 active"> {{trans('admin/dashboard.menus.finished_sessions')}}</li>
        </ol>
            ...
            <div class="col-12">
                <div class="card datable-custom ">
                    <div class="table-responsive">
                        ...
                        <livewire:admin.sessions-table status="finished" />
                    </div>
                </div>
            </div>
        </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === false) {
                        ...
                        closepopup.click();
                        window.livewire.emit('filterData', {status: 'finished'});
                    }
                },
