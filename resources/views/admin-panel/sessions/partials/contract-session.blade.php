<div class="row clients destination-item-0 mb-5">
    ...
    <div class="col-sm-3 col-md-3">
        <x-admin.number-input  symbol="%"  label="discount_percentage_value"
    ...
    <div class="col-sm-3 col-md-3">
        <x-admin.number-input  symbol="جنيه"  label="sessions_debt_for_client" name="sessions[0][sessions_debt_for_client]"
    ...
    <div class="col-sm-3 col-md-3">
        <x-admin.number-input  symbol="جنيه"  label="sessions_debt_for_company" name="sessions[0][sessions_debt_for_company]"
                               class="sessions_debt_for_company"></x-admin.number-input>
        <p class="old_price">  </p>
    ...
    <div class="col-sm-4 col-md-4">
        <x-admin.number-input symbol="جنيه"  label="total_sessions_debt_for_company_session" class="total_sessions_debt_for_company_session"
                              name="sessions[0][total_sessions_debt_for_company_session]"/>
    </div>

    <div class="col-sm-2 col-md-2">
        <x-admin.number-input label="receipt_count" class="receipt_count"
