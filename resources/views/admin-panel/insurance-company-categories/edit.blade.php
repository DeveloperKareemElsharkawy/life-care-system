...
@section('content')
    <div class="side-app">
        ...
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.insurance-company-categories.update',['insurance_company_category_id' => $insuranceCompanyCategory->id , 'insurance_company_id' =>$insuranceCompanyCategory->insurance_company_id  ])}}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <x-admin.drop-down-input :selected="$insuranceCompanyCategory->main_category_id" label="main_category_id" name="main_category_id"
                                                             :options="$categories" key-of-option="id"
                                                             key-of-value="name"></x-admin.drop-down-input>
                                </div>

                                <div class="col-sm-6 col-md-6">
                                    <x-admin.drop-down-input :selected="$insuranceCompanyCategory->category_id" label="category_id" name="category_id"
                                                             :options="$subCategories" key-of-option="id"
                                                             key-of-value="name"></x-admin.drop-down-input>
                                </div>


                                <div class="col-sm-12 col-md-12">
                                    <x-admin.number-input :value="$insuranceCompanyCategory->discount_price_value" name="discount_price_value"></x-admin.number-input>
                                </div>

                                <div class="col-sm-12 col-md-12">
                                    <x-admin.number-input :value="$insuranceCompanyCategory->discount_percentage_value" name="discount_percentage_value"></x-admin.number-input>
                                </div>
