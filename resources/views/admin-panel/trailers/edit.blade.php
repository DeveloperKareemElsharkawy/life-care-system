...
@section('content')
    <div class="side-app">
        ...
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.trailers.update',['trailer_id'=>$trailer->id])}}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="vehicle_type_id" id="vehicle_type_id"
                                            ...
                                            @foreach($vehiclesTypes as $trailersType)
                                                <option
                                                    @selected( $trailer->vehicle_type_id == $trailersType->id) value="{{$trailersType->id}}">{{$trailersType->name}}</option>
                                ...
                                <div class="owners-group mb-3"> {{-- Owners Group --}}
                                    @foreach($trailer->owners_percentage as $owner_percentage)
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="indigo"
                                                       class="colorinput-input" @checked($trailer->color == 'indigo')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="purple"
                                                       class="colorinput-input" @checked($trailer->color == 'purple')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="pink"
                                                       class="colorinput-input" @checked($trailer->color == 'pink')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="red"
                                                       class="colorinput-input" @checked($trailer->color == 'red')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="lime"
                                                       class="colorinput-input" @checked($trailer->color == 'lime')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="green"
                                                       class="colorinput-input" @checked($trailer->color == 'green')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="teal"
                                                       class="colorinput-input" @checked($trailer->color == 'teal')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="black"
                                                       class="colorinput-input" @checked($trailer->color == 'black')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="white"
                                                       class="colorinput-input" @checked($trailer->color == 'white')>
                    ...
                    <div class="card">
                        ...
                        <div class="form-group p-2">
                            <input type="file" id="image" name="image" class="dropify input_field p-5"
                                   data-default-file="{{ asset($trailer->imageUrl) }}"
                                   data-height="180"/>
                        </div>
                    </div>
                </div>
        ...
        @push('scripts')
            ...
            @javascript('auctionImagesList', json_decode($trailer->gallery))
            @javascript('license_start_date', $trailer->license_start_date->format('m/d/Y'))
            @javascript('license_end_date', $trailer->license_end_date->format('m/d/Y'))
