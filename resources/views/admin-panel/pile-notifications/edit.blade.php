    ...
    <div class="side-app">
        ...
        <!--Page header-->
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1"><a href="{{route('admin.colleges.index')}}" class="">
                            @lang('admin/dashboard.menus.colleges')</a>
                    </li>
                    <li class="breadcrumb-item1 active">  @lang('admin/datatable.buttons.u_college')
                    </li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25"> @lang('admin/datatable.buttons.u_college')</h1>
        </div>
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.colleges.update',['college_id'=>$college->id])}}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <x-admin.text-input name="name_ar" :value="$college->name_ar"></x-admin.text-input>
                                </div>

                                <div class="col-sm-6 col-md-6">
                                    <x-admin.text-input name="name_en" :value="$college->name_en"></x-admin.text-input>
                                </div>

                                <x-admin.checkbox-input name="status" :value="$college->status"> </x-admin.checkbox-input>
