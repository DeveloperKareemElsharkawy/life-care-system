    ...
    <div class="side-app">
        ...
        <!--Page header-->
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1"><a href="{{route('admin.pile-notifications.index')}}" class="">
                            @lang('admin/dashboard.menus.pile_notifications')</a>
                    </li>
                    <li class="breadcrumb-item1 active">  @lang('admin/datatable.buttons.c_pile_notification')
                    </li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25"> @lang('admin/datatable.buttons.c_pile_notification')</h1>
        </div>
        <form method="post" id="myform" autocomplete="off" action="{{route('admin.pile-notifications.store')}}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <x-admin.text-input name="subject"></x-admin.text-input>
                                </div>

                                <div class="col-sm-12 col-md-12">
                                    <x-admin.text-area-input name="body"></x-admin.text-area-input>
                                </div>


                                <div class="col-sm-12 col-md-12">
                                    <x-admin.drop-down-input label="pile_id" name="pile_id" :options="$piles" key-of-option="id"
                                                             key-of-value="name_ar"></x-admin.drop-down-input>
                                </div>
                ...
                <div class="col-xl-3 col-lg-3">
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-footer text-center card-form-footer">
                            ...
                            <a href="{{ route('admin.colleges.index') }}" class="btn btn-danger "> <span
