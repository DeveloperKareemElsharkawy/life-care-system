...
@section('content')
    <div class="side-app">
        ...
        <div class="page-header">
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1"><a href="{{route('admin.transport.fees.index')}}" class="">
                            @lang('admin/dashboard.menus.transport_fee')</a>
                    </li>
                    <li class="breadcrumb-item1 active"> @lang('admin/datatable.buttons.u_transport_fee')</li>
                </ol>
        ...
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.transport.fees.update',['transport_fee_id'=>$transportFee->id])}}"
              enctype="multipart/form-data"
              class="">
            @csrf

            <input type="hidden" name="VehicleType_id" value="{{$transportFee->id}}">
