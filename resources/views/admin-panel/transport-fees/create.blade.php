...
@section('content')
    <div class="side-app">
        ...
        <div class="page-header">
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1 active"> @lang('admin/datatable.buttons.c_transport_fee')</li>
                </ol>
        ...
        <form method="post" id="myform" autocomplete="off" action="{{route('admin.transport.fees.store')}}"
