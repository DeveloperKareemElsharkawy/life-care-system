...
@section('content')
    <div class="side-app">
        ...
        <div class="page-header">
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1 active">  @lang('admin/datatable.buttons.u_tag')
                    </li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25"> @lang('admin/datatable.buttons.u_tag')</h1>
        </div>
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.tags.update',['tag_id'=>$tag->id])}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="material-switch">
                                            <input id="status" name="status"
                                                   type="checkbox" @checked($tag->status) >
                ...
                <div class="col-xl-3 col-lg-3">
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-footer text-center card-form-footer">
                            ...
                            <a href="{{ route('admin.tags.index') }}" class="btn btn-danger "> <span
