...
@section('content')
    <div class="side-app">
        ...
        <!--Page header-->
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1"><a href="{{route('admin.categories.index')}}" class="">
                            @lang('admin/dashboard.menus.main_categories')</a>
                    </li>
                    <li class="breadcrumb-item1 active">  @lang('admin/datatable.buttons.c_main_category')
                    </li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25"> @lang('admin/datatable.buttons.c_main_category')</h1>
        </div>
