                ...
                <div class="predefined_styles">
                    <div class="swichermainleft text-center">
                        <div class="p-3 d-grid gap-2">
                            <a href="../index.html" target="_blank" class="btn ripple btn-primary mt-0">View Demo</a>
                            <a href="https://themeforest.net/item/azea-bootstrap-5-admin-dashboard-template/33518740"
                               target="_blank" class="btn ripple btn-success">Buy Now</a>
                            <a href="https://themeforest.net/user/spruko/portfolio" target="_blank"
                               class="btn ripple btn-red">Our Portfolio</a>
                        </div>
                    </div>
