    ...
    <div class="side-app">
        ...
        <ol class="breadcrumb1">
            ...
            <li class="breadcrumb-item1"><a
                    href="{{route('admin.sub-categories.index',['category_id' => $subCategory->parent_id])}}"
                    class="">
                    @lang('admin/dashboard.menus.sub_categories')</a>
            </li>
            <li class="breadcrumb-item1 active">  @lang('admin/datatable.buttons.u_sub_category')
            </li>
        </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25"> @lang('admin/datatable.buttons.u_sub_category')</h1>
        </div>
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.sub-categories.update',['sub_category_id'=>$subCategory->id,'category_id' => $subCategory->parent_id])}}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <x-admin.text-input :value="$subCategory->name" name="name"></x-admin.text-input>
                                </div>

                                <div class="col-sm-6 col-md-6">
                                    <x-admin.text-input :value="$subCategory->code" name="code"></x-admin.text-input>
                                </div>

                                <div class="col-sm-12 col-md-12">
                                    <x-admin.number-input :value="$subCategory->price" label="cash_price"
                                                          name="price"></x-admin.number-input>
                                </div>

                                <div class="col-sm-12 col-md-12">
                                    <x-admin.drop-down-input name="parent_id"
                                                             :selected="$subCategory->parent_id"
                ...
                <div class="col-xl-3 col-lg-3">
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-footer text-center card-form-footer">
                            ...
                            <a href="{{ route('admin.sub-categories.index',['category_id' => $subCategory->parent_id]) }}"
