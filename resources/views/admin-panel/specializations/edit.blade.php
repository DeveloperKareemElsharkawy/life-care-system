    ...
    <div class="side-app">
        ...
        <!--Page header-->
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1 active">  @lang('admin/datatable.buttons.u_main_category')
                    </li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25"> @lang('admin/datatable.buttons.u_main_category')</h1>
        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <x-admin.text-input :value="$category->name_ar" name="name_ar"></x-admin.text-input>
                                </div>

                                <div class="col-sm-6 col-md-6">
                                    <x-admin.text-input :value="$category->name_en" name="name_en"></x-admin.text-input>
                                </div>
