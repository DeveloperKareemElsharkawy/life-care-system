    ...
    <div class="side-app">
        ...
        <!--Page header-->
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1 active">  @lang('admin/datatable.buttons.c_contact_list')
                    </li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25"> @lang('admin/datatable.buttons.c_contact_list')</h1>
        </div>
        <form method="post" id="myform" autocomplete="off" action="{{route('admin.contacts-list.store',['user_id'=> $user])}}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <x-admin.text-input name="first_name"></x-admin.text-input>
                                </div>

                                <div class="col-sm-6 col-md-6">
                                    <x-admin.text-input name="last_name"></x-admin.text-input>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <x-admin.text-input name="phone"></x-admin.text-input>
                                </div>
