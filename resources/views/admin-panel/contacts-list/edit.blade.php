    ...
    <div class="side-app">
        ...
        <!--Page header-->
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1"><a href="{{route('admin.contacts-list.index',['user_id'=> $user])}}"
                                                    class="">
                            @lang('admin/dashboard.menus.contacts_list' ,['client' => $user->name])</a>
                    </li>
                    <li class="breadcrumb-item1 active">  @lang('admin/datatable.buttons.u_contact_list')
                    </li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25"> @lang('admin/datatable.buttons.u_contact_list')</h1>
        </div>
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.contacts-list.update',['contact_list_id'=>$contactList->id ,'user_id'=>$user->id])}}"
              enctype="multipart/form-data"
              class="">
            @csrf

            <input type="hidden" name="college_id" value="{{$contactList->id}}">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <x-admin.text-input :value="$contactList->first_name"
                                                        name="first_name"></x-admin.text-input>
                                </div>

                                <div class="col-sm-6 col-md-6">
                                    <x-admin.text-input :value="$contactList->last_name"
                                                        name="last_name"></x-admin.text-input>
                                </div>


                                <div class="col-sm-6 col-md-6">
                                    <x-admin.text-input :value="$contactList->email" name="email"></x-admin.text-input>
                                </div>

                                <div class="col-sm-6 col-md-6">
                                    <x-admin.text-input :value="$contactList->phone" name="phone"></x-admin.text-input>
                                </div>
                ...
                <div class="col-xl-3 col-lg-3">
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-footer text-center card-form-footer">
                            ...
                            <a href="{{route('admin.contacts-list.index',['user_id'=> $user])}}"
