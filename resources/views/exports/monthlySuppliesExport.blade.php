<table style="border-collapse: collapse; width: 100%; border: 1px solid #dddddd;">
    ...
    <tr>
        ...
        <td colspan="2"
            style="border: 4px solid #dddddd; padding: 20px; font-size: 15px; text-align: center; background-color: #63c363; color: #ffffff; font-weight: bold; direction: rtl;"> {{ $forMonth}}</td>
    </tr>
