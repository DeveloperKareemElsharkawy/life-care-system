...
')
     ...
     */ 
         ...
         * 
         *
         * @see \devsrv\LivewireModal\LivewireModalServiceProvider::boot()
         * @param mixed $msg
         * @static 
         */ 
        public static function info($msg)
        {
                        return \Livewire\Component::info($msg);
        }
                    /**
         * 
         *
        ...
        {
                        return \Livewire\Component::warning($msg);
        }
                    /**
         * 
         *
        ...
        {
                        return \Livewire\Component::success($msg);
        }
                    /**
         * 
         *
        ...
        {
                        return \Livewire\Component::danger($msg);
        }
